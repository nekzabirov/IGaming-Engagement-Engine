...
fun numberParamValueSubtypes(): List<SubtypeDescriptor> = listOf(
    SubtypeDescriptor(
        ...
        assets = listOf(AssetParamDescriptor(name = "threshold", type = ParamType.NUMBER, required = true)),
    ),
    SubtypeDescriptor(
    ...
    SubtypeDescriptor(
        ...
        assets = listOf(AssetParamDescriptor(name = "target", type = ParamType.NUMBER, required = true)),
    ),
)
...
fun dateParamValueSubtypes(): List<SubtypeDescriptor> = listOf(
    SubtypeDescriptor(
        ...
        assets = listOf(AssetParamDescriptor(name = "days", type = ParamType.NUMBER, required = true)),
    ),
    SubtypeDescriptor(
